...
export interface InitOutput {
  ...
  readonly toriiclient_getTokens: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly toriiclient_onTokenUpdated: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly toriiclient_getTokenBalances: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly toriiclient_onEventMessageUpdated: (
    a: number,
    b: number,
    c: any,
  ) => [number, number, number];
  readonly toriiclient_updateEventMessageSubscription: (a: number, b: number, c: number) => any;
  readonly toriiclient_onStarknetEvent: (
    a: number,
    b: number,
    c: number,
    d: any,
  ) => [number, number, number];
  readonly toriiclient_onIndexerUpdated: (
    a: number,
    b: number,
    c: number,
    d: any,
  ) => [number, number, number];
  readonly toriiclient_onTokenBalanceUpdated: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly toriiclient_updateTokenBalanceSubscription: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly toriiclient_publishMessage: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h25a2d6c0cac360bc: (
    a: number,
    b: number,
  ) => void;
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfd0262bcce7a58a4: (
    a: number,
    b: number,
  ) => void;
