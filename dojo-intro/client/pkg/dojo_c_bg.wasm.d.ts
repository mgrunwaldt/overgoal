...
export const verifyingkey_verify: (
  a: number,
  b: number,
  c: number,
  d: any,
...
export const toriiclient_getTokens: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const toriiclient_onTokenUpdated: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const toriiclient_getTokenBalances: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const toriiclient_onEntityUpdated: (
  a: number,
  b: number,
  c: any,
) => [number, number, number];
export const toriiclient_updateEntitySubscription: (a: number, b: number, c: number) => any;
export const toriiclient_onEventMessageUpdated: (
  a: number,
  b: number,
  c: any,
) => [number, number, number];
export const toriiclient_updateEventMessageSubscription: (a: number, b: number, c: number) => any;
export const toriiclient_onStarknetEvent: (
  a: number,
  b: number,
  c: number,
  d: any,
) => [number, number, number];
export const toriiclient_onIndexerUpdated: (
  a: number,
  b: number,
  c: number,
  d: any,
) => [number, number, number];
export const toriiclient_onTokenBalanceUpdated: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const toriiclient_updateTokenBalanceSubscription: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const toriiclient_publishMessage: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h25a2d6c0cac360bc: (
  a: number,
  b: number,
) => void;
export const closure1133_externref_shim: (a: number, b: number, c: any) => void;
export const closure1158_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfd0262bcce7a58a4: (
  a: number,
  b: number,
) => void;
export const closure2499_externref_shim: (a: number, b: number, c: any) => void;
export const closure2675_externref_shim: (a: number, b: number, c: any, d: any) => void;
