...
function __wbg_adapter_52(arg0, arg1) {
  wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h25a2d6c0cac360bc(
    arg0,
    arg1,
  );
}
...
function __wbg_adapter_69(arg0, arg1) {
  wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfd0262bcce7a58a4(
    arg0,
    arg1,
  );
}
...
function __wbg_adapter_72(arg0, arg1, arg2) {
  wasm.closure2499_externref_shim(arg0, arg1, arg2);
}

function __wbg_adapter_436(arg0, arg1, arg2, arg3) {
  wasm.closure2675_externref_shim(arg0, arg1, arg2, arg3);
}
...
const ControllerAccountFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class ToriiClient {
  ...
  getTokens(contract_addresses, token_ids, limit, cursor) {
    var ptr0 = isLikeNone(contract_addresses)
      ? 0
      : passArrayJsValueToWasm0(contract_addresses, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(token_ids)
      ? 0
      : passArrayJsValueToWasm0(token_ids, wasm.__wbindgen_malloc);
    var len1 = WASM_VECTOR_LEN;
    var ptr2 = isLikeNone(cursor)
      ? 0
      : passStringToWasm0(cursor, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len2 = WASM_VECTOR_LEN;
    const ret = wasm.toriiclient_getTokens(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
      len1,
      isLikeNone(limit) ? 0x100000001 : limit >>> 0,
      ptr2,
      len2,
    );
    return ret;
  ...
  getTokenBalances(contract_addresses, account_addresses, token_ids, limit, cursor) {
    var ptr0 = isLikeNone(contract_addresses)
      ...
      : passArrayJsValueToWasm0(contract_addresses, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(account_addresses)
      ? 0
      : passArrayJsValueToWasm0(account_addresses, wasm.__wbindgen_malloc);
    var len1 = WASM_VECTOR_LEN;
    var ptr2 = isLikeNone(token_ids)
      ? 0
      : passArrayJsValueToWasm0(token_ids, wasm.__wbindgen_malloc);
    var len2 = WASM_VECTOR_LEN;
    var ptr3 = isLikeNone(cursor)
      ? 0
      : passStringToWasm0(cursor, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len3 = WASM_VECTOR_LEN;
    const ret = wasm.toriiclient_getTokenBalances(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
  ...
  onEntityUpdated(clause, callback) {
    const ret = wasm.toriiclient_onEntityUpdated(
      this.__wbg_ptr,
      isLikeNone(clause) ? 0 : addToExternrefTable0(clause),
      callback,
    );
    if (ret[2]) {
      throw takeFromExternrefTable0(ret[1]);
  ...
  updateEntitySubscription(subscription, clause) {
    ...
    const ret = wasm.toriiclient_updateEntitySubscription(
      this.__wbg_ptr,
      subscription.__wbg_ptr,
      isLikeNone(clause) ? 0 : addToExternrefTable0(clause),
    );
    return ret;
  }
  ...
  onEventMessageUpdated(clause, callback) {
    const ret = wasm.toriiclient_onEventMessageUpdated(
      this.__wbg_ptr,
      isLikeNone(clause) ? 0 : addToExternrefTable0(clause),
      callback,
    );
  ...
  updateEventMessageSubscription(subscription, clause) {
    _assertClass(subscription, Subscription);
    const ret = wasm.toriiclient_updateEventMessageSubscription(
      this.__wbg_ptr,
      subscription.__wbg_ptr,
      isLikeNone(clause) ? 0 : addToExternrefTable0(clause),
    );
  ...
  onIndexerUpdated(contract_address, callback) {
    var ptr0 = isLikeNone(contract_address)
      ? 0
      : passStringToWasm0(contract_address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
  ...
  onTokenBalanceUpdated(contract_addresses, account_addresses, token_ids, callback) {
    ...
    var ptr2 = isLikeNone(token_ids)
      ...
      : passArrayJsValueToWasm0(token_ids, wasm.__wbindgen_malloc);
    var len2 = WASM_VECTOR_LEN;
    const ret = wasm.toriiclient_onTokenBalanceUpdated(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
  ...
  updateTokenBalanceSubscription(subscription, contract_addresses, account_addresses, token_ids) {
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.toriiclient_updateTokenBalanceSubscription(
      this.__wbg_ptr,
      subscription.__wbg_ptr,
      ptr0,
      len0,
...
function __wbg_get_imports() {
  ...
  imports.wbg.__wbg_desiredSize_5f5e5285daee0299 = function () {
    return handleError(function (arg0, arg1) {
  ...
  imports.wbg.__wbg_generateCertificate_9e84bb7f7662375c = function () {
    return handleError(function (arg0) {
  ...
  imports.wbg.__wbg_new_d85e20a34917132b = function () {
    return handleError(function (arg0, arg1) {
  ...
  imports.wbg.__wbg_newwithoptions_1ba541b69f220543 = function () {
    return handleError(function (arg0, arg1, arg2) {
  ...
  imports.wbg.__wbg_send_48418c7374637896 = function () {
    return handleError(function (arg0, arg1, arg2) {
  ...
  imports.wbg.__wbindgen_closure_wrapper2074 = function (arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 676, __wbg_adapter_52);
    return ret;
  };
  imports.wbg.__wbindgen_closure_wrapper3073 = function (arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 1134, __wbg_adapter_55);
    return ret;
  };
  ...
  imports.wbg.__wbindgen_closure_wrapper3117 = function (arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 1159, __wbg_adapter_62);
    return ret;
  };
  ...
  imports.wbg.__wbindgen_closure_wrapper5021 = function (arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 1931, __wbg_adapter_69);
    return ret;
  };
  imports.wbg.__wbindgen_closure_wrapper6324 = function (arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 2500, __wbg_adapter_72);
    return ret;
  };
...
async function __wbg_init(module_or_path) {
  ...
  if (typeof module_or_path === 'undefined') {
    module_or_path = new URL('dojo_c_bg.wasm', import.meta.url);
  }
  const imports = __wbg_get_imports();
